...
const cadastrar = (req, res) => {
    ...
    let query = `INSERT INTO vendas VALUES (DEFAULT, curdate(), ${data.quantidade}, ${data.produtoId}, ${data.vendedorId})`;
...
const alterar = (req, res) => {
    ...
    let query = `UPDATE vendas SET data = curdate(), quantidade = ${quantidade}, produtoId = ${produtoId}, vendedorId = ${vendedorId} WHERE id = '${id}'`;
...
const vendas = (req, res) => {
    let query = `SELECT ve.id, ve.data, ve.quantidade, p.nome AS nome_produto, v.nome AS nome_vendedor
    FROM vendas ve
